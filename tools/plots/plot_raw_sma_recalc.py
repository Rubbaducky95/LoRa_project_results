...
OUTPUT_PNG = r"C:\Users\ruben\Documents\LoRa Project\results\raw_test_data_plots\raw_sma_recalc_rssi_plots.png"
...
def main():
    ...
    for row_idx, (ax, bw) in enumerate(zip(axes, BWS_TO_PLOT)):
        ...
        ax.set_ylabel("Average SMA RSSI (recalc)")
