...
OUT_KALMAN = r"C:\Users\ruben\Documents\LoRa Project\results\plots\test_data2_kalman_rssi_plots.png"
OUT_SMA = r"C:\Users\ruben\Documents\LoRa Project\results\plots\test_data2_sma_rssi_plots.png"
...
def main():
    plot_metric(
        metric_col="kalman_rssi",
        ylabel="Average Kalman RSSI (dBm)",
        title="Average Kalman-filtered RSSI vs Distance by SF",
        out_png=OUT_KALMAN,
    )
    plot_metric(
        metric_col="sma_rssi",
        ylabel="Average SMA RSSI (dBm)",
        title="Average SMA RSSI vs Distance by SF",
        out_png=OUT_SMA,
    )
